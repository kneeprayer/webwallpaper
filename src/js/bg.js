...
function unsplashApiOverMaximumCallLimits() {
  saveBackground(
    "https://images.unsplash.com/photo-1467654513564-17c5e87d8f20?ixlib=rb-1.2.1&q=85&fm=jpg&crop=entropy&cs=srgb&ixid=eyJhcHBfaWQiOjQwOTIzfQ",
    "Patras",
    "Greece",
    "Patras"
  );
  saveBackground(
    "https://images.unsplash.com/photo-1543491434-cf5cd3f7da64?ixlib=rb-1.2.1&q=85&fm=jpg&crop=entropy&cs=srgb&ixid=eyJhcHBfaWQiOjQwOTIzfQ",
    "Tokyo",
    "Japan",
    "The city of houses"
  );
  saveBackground(
    "https://images.unsplash.com/photo-1494906084264-f315becbf75e?ixlib=rb-1.2.1&q=85&fm=jpg&crop=entropy&cs=srgb&ixid=eyJhcHBfaWQiOjQwOTIzfQ",
    "Fruita",
    "United States",
    "Colorado National Monument"
  );
  saveBackground(
    "https://images.unsplash.com/photo-1547078353-be807bdb3f8e?ixlib=rb-1.2.1&q=85&fm=jpg&crop=entropy&cs=srgb&ixid=eyJhcHBfaWQiOjQwOTIzfQ",
    "Toronto",
    "Canada",
    "7473 Eglinton Ave E, Toronto, ON M3C, Canada"
  );
  saveBackground(
    "https://images.unsplash.com/photo-1542029432708-e3f7968a4620?ixlib=rb-1.2.1&q=85&fm=jpg&crop=entropy&cs=srgb&ixid=eyJhcHBfaWQiOjQwOTIzfQ",
    "Bournemouth",
    "United Kingdom",
    "Boscombe Promenade, Bournemouth BH5 1BN, UK"
  );
